      ...
      <div className="container">
        ...
        <div className="testimonial-container slide-up stagger-2">
          <div className="testimonial-quote">
            "Tina and her team at Delia Design transformed our hotel lobby into a breathtaking space. Their eye for detail and commitment to quality is unmatched. The result feels both luxurious and welcoming."
          </div>
