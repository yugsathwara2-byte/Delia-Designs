        ...
        <div className="about-grid">
          <div className="about-content slide-up">
            ...
            <p className="about-text">
              Delia Designs is a full-service interior design firm in Washington, DC, specializing in hospitality, multi-family, and luxury residential projects. Founded by Tina Delia, our firm believes that your environment deeply influences your well-being.
            </p>
            <p className="about-text">
